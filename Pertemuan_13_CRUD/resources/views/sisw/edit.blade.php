    ...
    <form action="{{ route('sisw.update',$sisw->id) }}" method="POST">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>NIM:</strong>
                <input type="text" name="NIM" class="form-control" placeholder="NIS MAHASISWA" value="{{ $sisw->NIM }}">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Nama Mahasiswa:</strong>
                <input type="text" name="NamaMahasiswa" value="{{ $sisw->NamaMahasiswa }}" class="form-control" placeholder="NAMA MAHASISWA">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
